...
(lib.splinter = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#66FFFF").ss(4,1,1).p("AgbAAIA3AA");
	this.shape.setTransform(-0.05,-0.05);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.splinter, new cjs.Rectangle(-4.8,-2,9.6,4), null);
...
(lib.follower = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FF3300").s().p("AgXAYQgLgKAAgOQAAgNALgKQAKgLANAAQAOAAAKALQALAKAAANQAAAOgLAKQgKALgOAAQgNAAgKgLg");
	this.shape.setTransform(0,-12.55);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Layer_1
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#6600CC").ss(2,1,1).p("AAAjbIC+CoIhIEPIjrAAIhIkPg");

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("Ah1DcIhIkOIC9ipIC+CpIhIEOg");

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.follower, new cjs.Rectangle(-20,-23,40,46), null);
...
(lib.eye = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFF33").s().p("AglAlQgOgQAAgVQAAgVAOgQQAQgOAVAAQAWAAAPAOQAPAQAAAVQAAAVgPAQQgPAPgWAAQgVAAgQgPg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.eye, new cjs.Rectangle(-5.2,-5.2,10.5,10.5), null);
...
(lib.alien = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(-0.4805,-7.1153,1.0354,1.0423);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("AABBVQhVgCgmgyQAAg6AfgbQAmggA1AAQA1AAAnAgQAfAbAAA7QgiAzhTAAIgFAAg");
	this.shape_1.setTransform(-0.4805,-7.1153,1.0354,1.0423);
	...
	this.shape_4.setTransform(0.0113,7.0845,1.0354,1.0423);
	...
	this.shape_5.setTransform(0.0113,7.0845,1.0354,1.0423);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.alien, new cjs.Rectangle(-31,-17,62,34), null);
...
(lib.centipede = function(mode,startPosition,loop) {
	...
	this.eye.setTransform(0,-21.9);

	this.timeline.addTween(cjs.Tween.get(this.eye).wait(1));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#6600CC").ss(4,1,1).p("AAAldIEsELIhyGwIlzAAIhymwg");

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("Ai4FeIhzmwIErkLIEsELIhyGwg");

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.centipede, new cjs.Rectangle(-32,-37,64,74), null);
